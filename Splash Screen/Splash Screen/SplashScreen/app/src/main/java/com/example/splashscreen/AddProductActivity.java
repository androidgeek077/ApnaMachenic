...
public class AddProductActivity extends AppCompatActivity {
    ...
    private void addProduct() {
        ...
        if (image_uri == null) {
            ...
            //Creating ModelProduct for adding it to Firebase Database
...
//            hashMap.put("uid", "" + firebaseAuth.getUid());
            ...
            ModelProduct modelProduct = new ModelProduct(timestamp, productTitle, productDescription,
                    productCategory, productAvailability, "", originalPrice, discountPrice,
                    discountNote, discountAvailable + "", timestamp, firebaseAuth.getUid());
...
//            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            DatabaseReference reference = FirebaseDatabase.getInstance("https://apna-mechanic-cd1cf-default-rtdb.firebaseio.com/")
                    .getReference("Products").child(timestamp);
...
//                                hashMap.put("uid", "" + firebaseAuth.getUid());
                                ...
                                ModelProduct modelProduct = new ModelProduct(timestamp, productTitle, productDescription,
                                        productCategory, productAvailability, downloadImageUri + "", originalPrice, discountPrice,
                                        discountNote, discountAvailable + "", timestamp, firebaseAuth.getUid());
